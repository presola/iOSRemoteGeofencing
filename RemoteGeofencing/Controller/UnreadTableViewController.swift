//
//  UnreadTableViewController.swift
//  RemoteGeofencing
//
...
class UnreadTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return unreadGeoNotifications.count
    }
    
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "unreadDataCells", for: indexPath) as! NotificationCells
        
        // Configure the cell...
        var imageView : UIImageView
        imageView  = UIImageView(frame: CGRect(x: 20, y: 20, width: 34, height: 11))
        imageView.contentMode = .scaleAspectFit
        let object = unreadGeoNotifications[(indexPath as NSIndexPath).row]
